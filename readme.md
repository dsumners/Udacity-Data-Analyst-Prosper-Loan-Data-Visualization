...
Outside of the main variables of interest, the loan amount is positively correlated with the stated monthly income, this makes sense since borrowers with more monthly income could loan (borrow) more money. The loan amount is also increased with the increase of loan term. I also found that borrowers with better ratings tend to have larger monthly incomes and loan amounts. Employed, self-employed and full time borrowers have more monthly income and loan amount than part-time, retired and not employed borrowers. There is a interaction between categorical term and Prosper rating features. Proportionally, there are more 60 month loans on B and C ratings. There is only 36 months loans for HR rating borrowers. For loan amount, there is a interaction between term and rating. With a better Prosper rating, the loan amount of all three terms increases, the increase amplitude of loan amount between terms also becomes larger.


## Key Insights for Presentation

For the presentation, I just focused on features that could affect (improve) the borrower APR, which are original loan amount and Prosper rating. I started by showing the distribution of borrower APR and loan amount variable. Then, showed the relationship between APR vs loan amount, as well as APR vs. rating. Also investigated the effect of rating on ralationship between APR and loan amount, as well as the effect of rating on relationship between borrower APR and the term.
